 ...
 */
LRESULT CALLBACK zagl::win::WinFunc( HWND hWnd, UINT Msg,
 ...
 * RETURNS: None.
 */
VOID zagl::win::FlipFullScreen( VOID )
{
  if (!IsFullScreen)
  {
    HMONITOR hMon;
...
} /* End of 'zagl::anim::FlipFullScreen' function */
